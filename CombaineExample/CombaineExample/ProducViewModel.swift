...
//  CombaineExample
//
//  Created by Vakil on 26.05.2024.
//
...
final class ProductViewModel: ObservableObject {
    ...
    init() {
        dataToProducts = [
            StoreMerchandise(imageName: "star.circle.fill", name: "Банан", price: "157"),
            StoreMerchandise(imageName: nil, name: "Драконий фрукт", price: "250"),
            StoreMerchandise(imageName: "star.circle.fill", name: "Апельсин", price: "200"),
            StoreMerchandise(imageName: "star.circle.fill", name: "Дыня", price: "350"),
            StoreMerchandise(imageName: nil, name: "Арбуз", price: "200"),
            StoreMerchandise(imageName: "star.circle.fill", name: "Личи", price: "300"),
        ]
        bind()
    }
